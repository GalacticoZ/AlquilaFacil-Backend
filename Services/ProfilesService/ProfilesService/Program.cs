...
builder.Services.AddSwaggerGen(c =>
{
    ...
    {
        Title = "ProfilesService.API",
        Version = "v1",
        Description = "Profiles Service API - Gestión de perfiles de usuario",
...
if (app.Environment.IsDevelopment() || app.Environment.IsProduction())
{
    ...
    app.UseSwaggerUI(c =>
    {
        ...
        {
            c.SwaggerEndpoint("/profiles/swagger/v1/swagger.json", "Profiles Service API V1");
        }
