using ProfilesService.Profiles.Domain.Model.Aggregates;
using ProfilesService.Profiles.Domain.Model.Commands;
using ProfilesService.Profiles.Domain.Model.Queries;
using ProfilesService.Profiles.Domain.Services;
using ProfilesService.Profiles.Interfaces.REST;
using ProfilesService.Profiles.Interfaces.REST.Resources;
using Microsoft.AspNetCore.Mvc;
using Moq;

namespace ProfilesService.Tests.CoreIntegrationTests;
