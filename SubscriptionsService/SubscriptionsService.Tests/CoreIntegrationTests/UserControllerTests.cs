using SubscriptionsService.IAM.Domain.Model.Aggregates;
using SubscriptionsService.IAM.Domain.Model.Commands;
using SubscriptionsService.IAM.Domain.Model.Queries;
using SubscriptionsService.IAM.Domain.Services;
using SubscriptionsService.IAM.Interfaces.REST;
using SubscriptionsService.IAM.Interfaces.REST.Resources;
