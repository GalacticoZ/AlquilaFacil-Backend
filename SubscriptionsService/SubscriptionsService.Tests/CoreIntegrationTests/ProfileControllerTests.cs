using SubscriptionsService.Profiles.Domain.Model.Aggregates;
using SubscriptionsService.Profiles.Domain.Model.Commands;
using SubscriptionsService.Profiles.Domain.Model.Queries;
using SubscriptionsService.Profiles.Domain.Services;
using SubscriptionsService.Profiles.Interfaces.REST;
using SubscriptionsService.Profiles.Interfaces.REST.Resources;
