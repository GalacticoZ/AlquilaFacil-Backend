using SubscriptionsService.Booking.Domain.Model.Aggregates;
using SubscriptionsService.Booking.Domain.Model.Commands;
using SubscriptionsService.Booking.Domain.Model.Queries;
using SubscriptionsService.Booking.Domain.Services;
using SubscriptionsService.Booking.Interfaces.REST;
using SubscriptionsService.Booking.Interfaces.REST.Resources;
